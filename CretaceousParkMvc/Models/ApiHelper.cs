...
namespace CretaceousParkMvc.Models
{
  class ApiHelper
  {
    ...
    {
      RestClient client = new RestClient("http://localhost:5004/api"); // url port needs to match port in CretaceousParkApi/Properties/launchSettings.json -->"applicationUrl:..."
